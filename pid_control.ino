...
#define _DIST_MIN 160         //[20191979] 최소거리
#define _DIST_MAX 300         //[20191979] 최대거리

// Distance sensor
#define _DIST_ALPHA 0.44 //[20203118] DIST_ALPHA 값 설정

// Servo range
#define _DUTY_MIN 1000    // [20213083]서보 각도의 최솟값 설정
#define _DUTY_NEU 1810    // [20213090]서보 수평 각도 펄스 값
#define _DUTY_MAX 2000        // [20213081] 서보 각도의 최댓값

// Servo speed control
#define _SERVO_ANGLE 30 //[20203118] 최대 가동범위에 따른 목표 서보 회전각
#define _SERVO_SPEED 200 //[20203118] 서보 속도 설정
...
// PID parameters
#define _KP 3.1        //[20191979] 비례제어 값
#define _KD 30        // 미분제어 값
#define _KI 0.007        // 적분제어 값
...
float ir_distance2(){
  int volt = map(analogRead(PIN_IR), 0, 1023, 0, 5000);
  return (27.61 / (volt - 0.1696)) * 10000 + 75;
}
float ir_distance_filtered(void){ // return value unit: mm
  return ir_distance2(); // for now, just use ir_distance() without noise filter.
}